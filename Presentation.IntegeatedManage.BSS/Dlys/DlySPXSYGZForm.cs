...
{
    public partial class DlySPXSYGZForm : DlySPXSYGZForm_Design
    {
        public string NdxId { get; set; }

        public DlySPXSYGZForm(string ndxId)
        {
            InitializeComponent();
            NdxId = ndxId;
            if (!DesignMode)
        ...
        private void DlySPXSYGZForm_Load(object sender, EventArgs e)
        {
            try
            {
                this.Facade = new DlySPXSYGZFormFacade(this);
                this.Facade.SetData();
            }
            catch (Exception ex)
            {
        ...
        internal void SetData(SPXSDlyYGZNdxEntity entity)
        {
    ...
    public class DlySPXSYGZForm_Design : Base_Form<DlySPXSYGZFormFacade>
    {
    }
    public class DlySPXSYGZFormFacade : ActualBase<DlySPXSYGZForm>
    {
        ...
        public DlySPXSYGZFormFacade(DlySPXSYGZForm actual)
            : base(actual)
        { }
        internal void SetData()
        {
            var entity = _DlyNdxService.GetSPXSDlyYGZNdxEntity(this.Actual.NdxId);
