...
{
    public partial class DlySPXSTHYGZForm : DlySPXSTHYGZForm_Design
    {
        public string NdxId { get; set; }
        public DlySPXSTHYGZForm(string ndxId)
        {
            InitializeComponent();
            NdxId = ndxId;
            if (!DesignMode)
        ...
        private void DlySPXSTHYGZForm_Load(object sender, EventArgs e)
        {
            try
            {
                this.Facade = new DlySPXSTHYGZFormFacade(this);
                this.Facade.SetData();
            }
            catch (Exception ex)
            {
        ...
        internal void SetData(SPXSTHDlyYGZNdxEntity entity)
        {
    ...
    public class DlySPXSTHYGZForm_Design : Base_Form<DlySPXSTHYGZFormFacade>
    {
    }
    public class DlySPXSTHYGZFormFacade : ActualBase<DlySPXSTHYGZForm>
    {
        ...
        public DlySPXSTHYGZFormFacade(DlySPXSTHYGZForm actual)
            : base(actual)
        { }
        internal void SetData()
        {
            var entity = _DlyNdxService.GetSPXSTHDlyYGZNdxEntity(this.Actual.NdxId);
