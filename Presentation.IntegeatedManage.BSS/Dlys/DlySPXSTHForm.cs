...
{
    public partial class DlySPXSTHForm : DlySPXSTHForm_Design
    {
        public string NdxId { get; set; }
        private short TotalInputLevel = 0;
        public DlySPXSTHForm()
        {
            InitializeComponent();
            if (!DesignMode)
            {
        ...
        public DlySPXSTHForm(string ndxId)
            : this()
        {
            NdxId = ndxId;
        }

        private void DlySPXSTHForm_Load(object sender, EventArgs e)
        {
            try
            {
                this.Facade = new DlySPXSTHFormFacade(this);
                this.Facade.SetData();
        ...
        internal void SetData(SPXSTHDlyCGNdxEntity entity)
        {
        ...
        private void JSRNamePopupContainerEdit_Properties_QueryResultValue(object sender, DevExpress.XtraEditors.Controls.QueryResultValueEventArgs e)
        {
            try
            {
                ...
                var entity = this.bindbaseDataLayoutControl1.DataSource as SPXSTHDlyCGNdxEntity;
                if (result == null)
                {
        ...
        protected override void OnClosing(System.ComponentModel.CancelEventArgs e)
        {
            try
            {
                ...
                {
                    var data = this.bindbaseDataLayoutControl1.DataSource as SPXSTHDlyCGNdxEntity;
        ...
        private void SHRNameButtonEdit_Properties_ButtonClick(object sender, DevExpress.XtraEditors.Controls.ButtonPressedEventArgs e)
        {
            try
            {
                ...
                var spxsthdlycgndxentity = this.bindbaseDataLayoutControl1.DataSource as SPXSTHDlyCGNdxEntity;
                var property = spxsthdlycgndxentity.GetType().GetProperty(string.Format("SHRId{0}", inputlevel));
                var shrid = property.GetValue(spxsthdlycgndxentity, null).ToString();
                if (e.Button.Kind == DevExpress.XtraEditors.Controls.ButtonPredefines.OK)
                {
                    if (!DJSHChecker.CheckPreInputLevel(spxsthdlycgndxentity, inputlevel))
                    {
                        MessageBoxEx.Info("前面的审核流程未完成");
                        return;
                    }
                    if (DJSHChecker.CheckAfterInputLevel(spxsthdlycgndxentity, this.TotalInputLevel, inputlevel))
                    {
                    ...
                    property.SetValue(spxsthdlycgndxentity, AuthPrincipal.CurrentAuthPrincipal.AuthIdentity.UserId, null);
                ...
                else
                {
                    ...
                    property.SetValue(spxsthdlycgndxentity, string.Empty, null);
    ...
    public class DlySPXSTHForm_Design : Base_Form<DlySPXSTHFormFacade>
    {
    }
    public class DlySPXSTHFormFacade : ActualBase<DlySPXSTHForm>
    {
        ...
        public DlySPXSTHFormFacade(DlySPXSTHForm actual)
            : base(actual)
        { }
        ...
        internal void SetData()
        {
            ...
            {
                if (!_InputLevelService.CheckInputLevel(FengSharp.OneCardAccess.Application.Config.DlyConfig.SPXSTHDlyTypeId, ((short)1)))
                {
                    throw new BusinessException("您不是一级审核人");
                }
                var entity = new SPXSTHDlyCGNdxEntity();
                entity.DlyNo = _DlyNdxService.GetNewDlyNo(FengSharp.OneCardAccess.Application.Config.DlyConfig.SPXSTHDlyTypeId);
                ...
                entity.DlyTypeId = FengSharp.OneCardAccess.Application.Config.DlyConfig.SPXSTHDlyTypeId;
            ...
            {
                var entity = _DlyNdxService.GetSPXSTHDlyCGNdxEntity(this.Actual.NdxId);
        ...
        {
            short totalInputLevel = _InputLevelService.GetTotalInputLevel(FengSharp.OneCardAccess.Application.Config.DlyConfig.SPXSTHDlyTypeId);
        ...
        {
            _InputLevelService.SHDJ(FengSharp.OneCardAccess.Application.Config.DlyConfig.SPXSTHDlyTypeId, inputlevel, this.Actual.NdxId);
        }

        internal void FSDJ(short inputlevel)
        {
            _InputLevelService.FSDJ(FengSharp.OneCardAccess.Application.Config.DlyConfig.SPXSTHDlyTypeId, inputlevel, this.Actual.NdxId);
        }
