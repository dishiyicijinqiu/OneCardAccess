...
{
    public class CompanySelectPopupContainerControl : PopupContainerControl, IMultCompanySelect, ISingleCompanySelect
    {
        private bool isMulSelect = false;
        private bool isCateCanSelect = false;
        private CompanySelectUserControl selectUserControl1;
        public CompanySelectPopupContainerControl(bool isMulSelect = false, bool isCateCanSelect = false)
        {
            InitializeComponent();
        ...
        void selectUserControl1_BeforeBind(Infrastructure.Events.CEventArgs<CompanyCMCateEntity[]> e)
        {
            if (BeforeBind != null)
            {
                this.BeforeBind(e);
        ...
        {
            this.selectUserControl1 = new CompanySelectUserControl();
        ...
        public CompanyCMCateEntity GetResult()
        {
            return this.selectUserControl1.EntityResult;
        }
        public CompanyCMCateEntity[] GetResults()
        {
